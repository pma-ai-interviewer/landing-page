...
const plans = [
  {
    name: 'Free',
    tag: null,
    subtitle: 'PMA students unlimited free access',
    price: '$0',
    period: '',
    cta: 'Get started',
    ctaVariant: 'ghost',
  ...
  },
  {
    name: 'Pro',
    tag: null,
    subtitle: 'Intensive practice and coaching',
    price: '$199',
    period: '/ month',
    cta: 'Sign up',
    ctaVariant: 'dark',
    description: 'For candidates in intensive interview prep who want maximum practice volume and coaching support.',
    features: [
      '800 mock interview sessions per month',
      'Access to unlimited practice questions',
      'Comprehensive AI feedback and improvement tips',
      'Performance analytics to track your growth over time',
      'All question categories & difficulty levels',
      'Exclusive PMA career panels with tech leaders and PMA alumni',
    ],
  },
]
